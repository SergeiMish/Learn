...
public class StepTracker {
    ...
    void printStatistic() {
        ...
        System.out.println("Расстояние пройденное за месяц " + converter.convertToKm(sumSteps));     // вывод пройденной за месяц дистанции в километрах
        System.out.println("Количество сожженых калорий за месяц " + converter.convertStepsToKilocalories(sumSteps));    // вывод количества сожжённых килокалорий за месяц
